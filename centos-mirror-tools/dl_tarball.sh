...
for line in $(cat $tarball_file); do
    ...
    if [[ "$line" =~ ^'!' ]]; then
        ...
        # of maven artifacts described in mvn-artifacts file.
            ...
            cp "${srpm_path}/mlnx-ofa_kernel-4.4-OFED.4.4.2.0.7.1.gee7aa0e.src.rpm" .
            cp "${srpm_path}/rdma-core-43mlnx1-1.44207.src.rpm" .
            cp "${srpm_path}/libibverbs-41mlnx1-OFED.4.4.2.0.1.44207.src.rpm" .
