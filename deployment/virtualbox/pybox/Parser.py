...
def handle_args():
    ...
    ******************************************
    ...
    parser.add_argument("--config-files-dir", help=
        """
        Directory with config files, scripts, images (i.e. lab_setup.sh, lab_setup.conf, ...)
    ...
    parser.add_argument("--config-controller-ini", help=
        ...
        (e.g. TiS_config.ini_centos, ~/TiS_config.ini_centos, /home/myousaf ...).
        """,
        type=str)
    ...
    **************************************
    ...
    parser.add_argument("--kubernetes", help=
        """
        Run config_controller with --kubernetes option
        """,
        action='store_true')
    return parser
